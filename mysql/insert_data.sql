...
insert into track(cd_id, track_id, title) values(1, 2, 'Breath');
...
insert into track(cd_id, track_id, title) values(2, 5, 'Shine on you crazy diamond');

insert into track(cd_id, track_id, title) values(3, 1, 'Sun');
insert into track(cd_id, track_id, title) values(3, 2, 'Fucker');

insert into track(cd_id, track_id, title) values(4, 1, 'Bitch');
insert into track(cd_id, track_id, title) values(4, 2, 'Whole');
insert into track(cd_id, track_id, title) values(4, 3, '呵呵哒');
